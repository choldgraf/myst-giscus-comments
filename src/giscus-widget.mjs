...
function render({ model, el }) {
  ...
  // Build the giscus iframe URL (matching giscus client.js behavior)
  ...
  iframe.src = `https://giscus.app/${lang}/widget?${params}`;
